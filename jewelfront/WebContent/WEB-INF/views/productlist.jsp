             ...
             <div class="panel-body">
               <table class="table table-striped table-bordered table-list">
                 ...
                 <tbody>
                         ...
                         <tr>
                         <td>
                            <a class="btn btn-default" href="product_edit?id=${p.p_id}">  EDIT<em class="fa fa-pencil"></em></a>
                             <a class="btn btn-danger" href="product_delete?id=${p.p_id}" >DELETE<em class="fa fa-trash"></em></a>
                           </td>
